...
static const char usage[] =
	...
	"      --override-icon <path>          Override notification icon, a Freedesktop\n"
	"                                      icon name, a file:// URI or an absolute path.\n"
	"      --default-icon <path>           Set a default icon if notification doesn't\n"
	"                                      have one, a Freedesktop icon name,\n"
	"                                      a file:// URI or an absolute path.\n"
